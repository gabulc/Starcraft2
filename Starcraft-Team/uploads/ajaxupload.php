...
<?php
	if($imgUploaded){
		echo '<img src="http://localhost/Starcraft-Team/Imagenes/success.gif" width="16" height="16" border="0" style="marin-bottom: -4px;" /> Success!<br /><img src="../../'.$upload_image.'" border="0" />';
	}else{
		echo '<img src="http://localhost/Starcraft-Team/Imagenes/error.gif" width="16" height="16px" border="0" style="marin-bottom: -3px;" /> Error(s) Found: ';
